...
mkdir /k8s
cd /k8s
wget https://gitee.com/guoshaosong/scripts/raw/master/common.sh && sh common.sh
#获取master节点ip
...
wget https://gitee.com/guoshaosong/scripts/raw/master/common.sh && sh common.sh && sh /b.sh
